...
if(init<- 1) { #== init ===
	...
	if(fromSrc <- 1) source('m:/50_HLP/out/packages/WorkJournal/inst/WorkJournal.r') # T:/work/UseR-2013/lib/zCode.r
...
Pro:
 ...
 -	Search  Ctrl+H
 -	Multi-win, monitors
 -	Also py, java, html, pig, hive, svn, git, shell, ... editors
...
'
	...
	{ ###  Block Header 2  === 2013-07-03 12:18:09"
		...
		if(0){ #==  rCharts   ==
			# nice demo: http://rpubs.com/Abresler/rCharts_Test
