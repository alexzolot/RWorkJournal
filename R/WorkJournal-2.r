...
#' @title gff
#' @aliases gff 
gff= function(patt=' ===', pattNeg='gff', f= theFile, withLineNumb= TRUE){ # grep pattern in the file
	catt(3099,'============================ gff:', f)
...
CreateProj= CreateProject= CreateNewProj= function(newProj.name= 'newProjTemplName'
		, Templ.dir= 'TRUE:/work/UseR-2013/99_commonR/newProjTemplName'
		, root='TRUE:/work/UseR-2013'
...
#' @param file - input R file
#' @title c2r= Comments2Roxygen
#' @aliases c2r Comments2Roxygen 
c2r= Comments2Roxygen= function(file=theFile, suffOut='-copy', fsub=TRUE, exec=TRUE,...) {
	if(fsub){
		fsub(fin= file
